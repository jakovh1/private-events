...
ActiveRecord::Schema[8.0].define(version: 2025_08_10_214141) do
  create_table "event_attendances", force: :cascade do |t|
    ...
    t.index ["attendee_id", "event_id"], name: "index_event_attendances_on_attendee_id_and_event_id", unique: true
